          ...
          <div className={style.collecB}>
            ...
            <div className={style.LabelInput}>
              ...
              <label htmlFor="BEDROOM">
                <input name="BEDROOM" type="checkbox" />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <label htmlFor="LIVING ROOM">
                <input name="LIVING ROOM" type="checkbox" />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <label htmlFor="LIBRARY">
                <input name="LIBRARY" type="checkbox" />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <label htmlFor="OFFICE">
                <input name="OFFICE" type="checkbox" />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <label htmlFor="LAUNDRY ROOM">
                <input name="LAUNDRY ROOM" type="checkbox" />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <label htmlFor="GUEST ROOM">
                <input name="GUEST ROOM" type="checkbox" />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <label htmlFor="FAMILY ROOM">
                <input name="FAMILY ROOM" type="checkbox" />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
